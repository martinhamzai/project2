    ...
    extends TestCase
{
    ...
    public void testDuplicates()
    {
        ...
        systemOut().clearHistory();
        cmdProc.processor("regionsearch 240 240 800 800");
        String str2 = systemOut().getHistory();
        str = str.substring(str.indexOf("QuadTree"));
        assertEquals(
            str2, "Points intersecting region (240, 240, 800, 800):\r\n"
                + "Point found: (p900, 900, 900)\r\n"
                + "Point found: (p901, 901, 901)\r\n"
                + "Point found: (p902, 902, 902)\r\n"
                + "Point found: (p902, 902, 902)\r\n"
                + "54 quadtree nodes visited\r\n");
    }
